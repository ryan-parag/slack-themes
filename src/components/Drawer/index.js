...
const DrawerContainer = styled.div`
  ...
  transition: transform ${appearDuration}ms ease-in-out;
  z-index:9000;
    ...
    <>
      <CSSTransition
        ...
        classNames={{
          ...
          exit: 'slideOut-exit',
          exitActive: 'slideOut-exit-active',
        }}
        unmountOnExit
      >
        <DrawerContainer>
          ...
          <div>
            <ThemeButton style={{ marginRight: '1.6rem' }} onClick={buttonThemeToggle} className={props.theme === 'dark' ? null : 'active'}>
            ...
            <ThemeButton onClick={buttonThemeToggle} className={props.theme === 'light' ? null : 'active'}>
