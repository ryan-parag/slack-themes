  ...
  return(
    <>
      <DrawerContainer>
        ...
        <div>
          <ThemeButton style={{marginRight: '1.6rem'}} onClick={props.theme === 'dark' ? props.toggleTheme.bind(this) : null} className={props.theme === 'dark' ? null : 'active'}>
          ...
          <ThemeButton onClick={props.theme === 'light' ? props.toggleTheme.bind(this) : null} className={props.theme === 'light' ? null : 'active'}>
